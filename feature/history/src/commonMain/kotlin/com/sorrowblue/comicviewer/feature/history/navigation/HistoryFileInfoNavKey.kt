...
@Serializable
internal data class HistoryFileInfoNavKey(override val fileKey: File.Key) : FileInfoNavKey {
    override val isOpenFolderEnabled: Boolean = true
}

@NavigationEntry
context(scope: EntryProviderScope<NavKey>)
internal fun historyFileInfoNavEntry(navigator: Navigator) {
    fileInfoEntry2<HistoryFileInfoNavKey>(
        sceneKey = "History",
