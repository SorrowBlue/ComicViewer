...
import comicviewer.feature.settings.extension.generated.resources.settings_extension_imagecache_label_page
import comicviewer.feature.settings.extension.generated.resources.settings_extension_imagecache_label_thumbnail
...
private fun ThumbnailImageCacheItem(imageCache: ThumbnailImageCache, onClick: () -> Unit) {
    Setting(
        title = {
            Text(text = stringResource(Res.string.settings_extension_imagecache_label_thumbnail))
        },
        onClick = {},
        summary = {
            Column {
...
private fun BookPageImageCacheItem(imageCache: BookPageImageCache, onClick: () -> Unit) {
    Setting(
        title = {
            Text(text = stringResource(Res.string.settings_extension_imagecache_label_page))
        },
        onClick = {},
        summary = {
            Column {
