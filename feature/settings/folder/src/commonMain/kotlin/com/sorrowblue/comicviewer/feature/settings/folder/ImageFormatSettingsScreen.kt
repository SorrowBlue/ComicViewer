...
@Serializable
data class ImageFormatSettings(val imageFormat: ImageFormat)

@Destination<ImageFormatSettings>(style = DestinationStyle.Dialog::class)
@Composable
internal fun ImageFormatSettingsScreen(
    route: ImageFormatSettings,
    resultNavigator: NavResultSender<ImageFormat>,
) {
    ImageFormatSettingsScreen(
        currentImageFormat = route.imageFormat,
