...
val ComicIcons.BookRibbon: ImageVector
    get() {
        ...
        _MaterialSymbolsBook_ribbon = ImageVector.Builder(
            name = "book_ribbon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                close()
                moveToRelative(-340f, -57f)
                close()
            }
        }.build()

        return _MaterialSymbolsBook_ribbon!!
    }

private var _MaterialSymbolsBook_ribbon: ImageVector? = null
