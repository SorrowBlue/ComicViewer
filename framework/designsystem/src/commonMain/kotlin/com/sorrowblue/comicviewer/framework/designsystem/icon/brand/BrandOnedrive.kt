...
val ComicIcons.BrandOnedrive: ImageVector
    get() {
        if (brandOnedrive != null) {
            return brandOnedrive!!
        }
        brandOnedrive = ImageVector.Builder(
            name = "BrandOnedrive",
            ...
            arcTo(
                horizontalEllipseRadius = 7.961F,
                verticalEllipseRadius = 7.961F,
                theta = 0.0F,
                isMoreThanHalf = false,
                isPositiveArc = true,
                x1 = 12.202F,
            ...
            arcTo(
                horizontalEllipseRadius = 7.997F,
                verticalEllipseRadius = 7.997F,
                theta = 0.0F,
                isMoreThanHalf = false,
                isPositiveArc = false,
                x1 = 1.437F,
            ...
            lineToRelative(-5.924F, 2.493F)
            arcTo(
                horizontalEllipseRadius = 7.989F,
                verticalEllipseRadius = 7.989F,
                theta = 0.0F,
                isMoreThanHalf = false,
                isPositiveArc = false,
                x1 = 8.0F,
...
private var brandOnedrive: ImageVector? = null
