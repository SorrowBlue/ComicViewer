 ...
 * [ToggleFloatingActionButton] to provide additional
 * choices to the user after clicking a FAB.
 *
 * @sample androidx.compose.material3.samples.FloatingActionButtonMenuSample
 * @param expanded whether the FAB Menu is expanded, which will trigger a
 *    staggered animation of the FAB Menu Items
 * @param button a composable which triggers the showing and hiding of the
 *    FAB Menu Items via the [expanded] state, typically a
 *    [ToggleFloatingActionButton]
 * @param modifier the [Modifier] to be applied to this FAB Menu
 * @param horizontalAlignment the horizontal alignment of the FAB Menu
 *    Items
 * @param content the content of this FAB Menu, typically a list of
 *    [FloatingActionButtonMenuItem]s
 */
...
// TODO: link to spec and image
/**
 * FAB Menu Items should be used within a [FloatingActionButtonMenu] to
 ...
 * @param icon optional icon for this FAB Menu Item, typically an
 *    [androidx.compose.material3.Icon]
 * @param modifier the [Modifier] to be applied to this FAB Menu Item
 * @param containerColor the color used for the background of this FAB Menu
 *    Item
 * @param contentColor the preferred color for content inside this FAB Menu
 *    Item. Defaults to either the matching content color for
 *    [containerColor], or to the current
 *    [androidx.compose.material3.LocalContentColor] if [containerColor] is
 *    not a color from the theme.
 */
@ExperimentalMaterial3ExpressiveApi
@Composable
fun FloatingActionButtonMenuScope.FloatingActionButtonMenuItem(
    ...
    contentColor: Color = _root_ide_package_.androidx.compose.material3.contentColorFor(
        containerColor
    ),
) {
...
// TODO: link to spec and image
/**
 * Toggleable FAB supports animating its container size, corner radius,
 * and color when it is toggled, and should be used in conjunction with a
 * [FloatingActionButtonMenu] to provide additional choices to the user
 * after clicking the FAB.
 *
 * Use [ToggleFloatingActionButtonDefaults.animateIcon] to animate the
 * color and size of the icon while the [ToggleFloatingActionButton] is
 * being toggled.
 *
 * @sample androidx.compose.material3.samples.FloatingActionButtonMenuSample
 * @param checked whether this Toggleable FAB is checked
 * @param onCheckedChange callback to be invoked when this Toggleable FAB
 *    is clicked, therefore the change of the state in requested
 * @param modifier the [Modifier] to be applied to this Toggleable FAB
 * @param containerColor the color used for the background of this
 *    Toggleable FAB, based on the checked progress value from 0-1
 * @param contentAlignment the alignment of this Toggleable FAB when
 *    checked
 * @param containerSize the size of this Toggleable FAB, based on the
 *    checked progress value from 0-1
 * @param containerCornerRadius the corner radius of this Toggleable FAB,
 *    based on the checked progress value from 0-1
 * @param content the content of this Toggleable FAB, typically an
 *    [androidx.compose.material3.Icon] that switches from an Add to a
 *    Close sign at 50% checked progress
 */
@ExperimentalMaterial3ExpressiveApi
@Composable
 ...
 * being toggled.
 *
 * This overload of Toggleable FAB also supports a [checkedProgress] param
 * which is used to drive the toggle animation.
 *
 * @sample androidx.compose.material3.samples.FloatingActionButtonMenuSample
 * @param checked whether this Toggleable FAB is checked
 * @param onCheckedChange callback to be invoked when this Toggleable FAB
 *    is clicked, therefore the change of the state in requested
 * @param checkedProgress callback that provides the progress value for the
 *    checked and unchecked animations
 * @param modifier the [Modifier] to be applied to this Toggleable FAB
 * @param containerColor the color used for the background of this
 *    Toggleable FAB, based on the checked progress value from 0-1
 * @param contentAlignment the alignment of this Toggleable FAB when
...
object ToggleFloatingActionButtonDefaults {
    ...
    /**
     * Modifier for animating the color and size of an icon within
     * [ToggleFloatingActionButton] based on a progress value.
     *
     * @param checkedProgress callback that provides the progress value for the
     *    icon animation
     * @param color the color of the icon, based on the checked progress value
     *    from 0-1
     * @param size the size of the icon, based on the checked progress value
     *    from 0-1
     */
    @Composable
