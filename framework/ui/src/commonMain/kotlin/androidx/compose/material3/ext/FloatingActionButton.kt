...
import androidx.compose.material3.ext.FloatingActionButtonDefaults.elevation
import androidx.compose.material3.ext.FloatingActionButtonDefaults.loweredElevation
 ...
 *
 * The FAB represents the most important action on a screen. It puts key
 * actions within reach.
 *
 * ![FAB
 * image](https://developer.android.com/images/reference/androidx/compose/material3/fab.png)
 *
 ...
 * @param shape defines the shape of this FAB's container and shadow (when
 *    using [elevation])
 * @param containerColor the color used for the background of this FAB. Use
 *    [Color.Transparent] to have no color.
 * @param contentColor the preferred color for content inside this FAB.
 *    Defaults to either the matching content color for [containerColor],
 *    or to the current [LocalContentColor] if [containerColor] is not a
 *    color from the theme.
 * @param elevation [FloatingActionButtonElevation] used to resolve the
 *    elevation for this FAB in different states. This controls the size of
 *    the shadow below the FAB. Additionally, when the container color is
 *    [ColorScheme.surface], this controls the amount of primary color
 ...
 *
 * FABs can also be shown and hidden with an animation when the main
 * content is scrolled:
 *
 ...
 *
 * Extended FABs help people take primary actions. They're wider than FABs
 * to accommodate a text label and larger target area.
 *
 * The other small extended floating action button overload supports a text
 * label and icon.
 *
 ...
 * to accommodate a text label and larger target area.
 *
 * The other medium extended floating action button overload supports a
 * text label and icon.
 *
 ...
 * to accommodate a text label and larger target area.
 *
 * The other large extended floating action button overload supports a text
 * label and icon.
 *
 ...
 *
 * The other extended floating action button overload supports a text label
 * and icon.
 *
 ...
 * to accommodate a text label and larger target area.
 *
 * The other small extended floating action button overload is for FABs
 * without an icon.
 *
 * Default content description for accessibility is extended from the
 * extended fabs icon. For custom behavior, you can provide your own via
 * [Modifier.semantics].
 *
 ...
 * @param onClick called when this FAB is clicked
 * @param modifier the [Modifier] to be applied to this FAB
 * @param expanded controls the expansion state of this FAB. In an expanded
 *    state, the FAB will show both the [icon] and [text]. In a collapsed
 *    state, the FAB will show only the [icon].
 * @param shape defines the shape of this FAB's container and shadow (when
 *    using [elevation])
 * @param containerColor the color used for the background of this FAB. Use
 *    [Color.Transparent] to have no color.
 ...
 * to accommodate a text label and larger target area.
 *
 * The other medium extended floating action button overload is for FABs
 * without an icon.
 *
 * Default content description for accessibility is extended from the
 * extended fabs icon. For custom behavior, you can provide your own via
 ...
 * to accommodate a text label and larger target area.
 *
 * The other large extended floating action button overload is for FABs
 * without an icon.
 *
 * Default content description for accessibility is extended from the
 * extended fabs icon. For custom behavior, you can provide your own via
 ...
 * image](https://developer.android.com/images/reference/androidx/compose/material3/extended-fab.png)
 *
 * The other extended floating action button overload is for FABs without
 * an icon.
 *
 * Default content description for accessibility is extended from the
 * extended fabs icon. For custom behavior, you can provide your own via
...
object FloatingActionButtonDefaults {
    ...
    /**
     * Creates a [FloatingActionButtonElevation] that represents the elevation
     * of a [FloatingActionButton] in different states. For use cases in
     * which a less prominent [FloatingActionButton] is possible consider the
     * [loweredElevation].
     *
     * @param defaultElevation the elevation used when the
     *    [FloatingActionButton] has no other [Interaction]s.
     * @param pressedElevation the elevation used when the
     *    [FloatingActionButton] is pressed.
     * @param focusedElevation the elevation used when the
     *    [FloatingActionButton] is focused.
     * @param hoveredElevation the elevation used when the
     *    [FloatingActionButton] is hovered.
     */
    @Composable
    fun elevation(
    ...
    /**
     * Use this to create a [FloatingActionButton] with a lowered elevation for
     * less emphasis. Use [elevation] to get a normal [FloatingActionButton].
     *
     * @param defaultElevation the elevation used when the
     *    [FloatingActionButton] has no other [Interaction]s.
     * @param pressedElevation the elevation used when the
    ...
    /**
     * Use this to create a [FloatingActionButton] that represents the default
     * elevation of a [FloatingActionButton] used for [BottomAppBar] in
     * different states.
     *
     * @param defaultElevation the elevation used when the
     *    [FloatingActionButton] has no other [Interaction]s.
...
/**
 * Apply this modifier to a [FloatingActionButton] to show or hide it with
 * an animation, typically based on the app's main content scrolling.
 *
 * @param visible whether the FAB should be shown or hidden with an
 *    animation
 * @param alignment the direction towards which the FAB should be scaled to
 *    and from
 * @param targetScale the initial scale value when showing the FAB and the
 *    final scale value when hiding the FAB
 * @param scaleAnimationSpec the [AnimationSpec] to use for the scale part
 *    of the animation, if null the Fast Spatial spring spec from the
 *    [MotionScheme] will be used
 * @param alphaAnimationSpec the [AnimationSpec] to use for the alpha part
 *    of the animation, if null the Fast Effects spring spec from the
 *    [MotionScheme] will be used
 * @sample androidx.compose.material3.samples.AnimatedFloatingActionButtonSample
 */
