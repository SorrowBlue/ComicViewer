...
@Stable
private class NonZeroInsets(private val first: WindowInsets, private val second: WindowInsets) :
    WindowInsets {
    ...
    override fun getTop(density: Density) = first.getTop(density).let {
