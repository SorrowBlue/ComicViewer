...
import com.sorrowblue.comicviewer.framework.ui.navigation.rememberNavigationState
...
fun rememberComicViewerUIState(allowNavigationRestored: Boolean = true): ComicViewerUIState {
    ...
    val navigationState: NavigationState = rememberNavigationState(
        startRoute = BookshelfKey.List,
        topLevelRoutes = remember {
            setOf(
                BookshelfKey.List,
                CollectionKey.List,
                ReadLaterKey.List,
...
private class ComicViewerUIStateImpl(
    ...
    override lateinit var navigationState: NavigationState
