...
other intellectual property rights related to it, still belong to Sorrow Blue.

Sorrow Blue is committed to ensuring that the app is as useful and efficient as possible. For that
...
The ComicViewer app stores and processes personal data that you have provided to us, to provide my
...
features and it could mean that the ComicViewer app won’t work properly or at all.
...
You should be aware that there are certain things that Sorrow Blue will not take responsibility for.
Certain functions of the app will require the app to have an active internet connection. The
connection can be Wi-Fi or provided by your mobile network provider, but Sorrow Blue cannot take
...
Along the same lines, Sorrow Blue cannot always take responsibility for the way you use the app i.e.
You need to make sure that your device stays charged – if it runs out of battery and you can’t turn
it on to avail the Service, Sorrow Blue cannot accept responsibility.

With respect to Sorrow Blue’s responsibility for your use of the app, when you’re using the app,
...
to you. Sorrow Blue accepts no liability for any loss, direct or indirect, you experience as a
...
Sorrow Blue does not promise that it will always update the app so that it is relevant to you and/or
...
me at sorrowblue.dev@gmail.com.
