...
graph TB
  ...
  subgraph :app
    :app:androidBenchmark["androidBenchmark"]
  ...
  :app:androidBenchmark --> :app:androidApp
...
class :app:androidBenchmark unknown
class :app:androidApp android-application
