...
@OptIn(ExperimentalForeignApi::class)
inline fun z_stream.deflateGetDictionary(
    dictionary: CValuesRef<UByteVar>?,
    dictLength: CValuesRef<UIntVar>?,
) = deflateGetDictionary(this.ptr, dictionary, dictLength)

@OptIn(ExperimentalForeignApi::class)
inline fun z_stream.deflateSetDictionary(
    dictionary: CValuesRef<UByteVar>?,
    dictLength: UInt,
) = deflateSetDictionary(this.ptr, dictionary, dictLength)
...
@OptIn(ExperimentalForeignApi::class)
inline fun z_stream.inflateGetDictionary(
    dictionary: CValuesRef<UByteVar>?,
    dictLength: CValuesRef<UIntVar>?,
) = inflateGetDictionary(this.ptr, dictionary, dictLength)

@OptIn(ExperimentalForeignApi::class)
inline fun z_stream.inflateSetDictionary(
    dictionary: CValuesRef<UByteVar>?,
    dictLength: UInt,
) = inflateSetDictionary(this.ptr, dictionary, dictLength)
