...
package com.sorrowblue.comicviewer.data.sync.worker
...
internal class ThumbnailScanWorker(
                ...
                NotificationCompat
                    ...
                    .setContentTitle(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_thumbnail_scan_title,
                        ),
                    )
                    .setContentText(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_thumbnail_scan_cancelled,
                        ),
                    )
        ...
        return regenerateThumbnailsUseCase(useCaseRequest).fold({
            val notification =
                NotificationCompat
                    ...
                    .setContentTitle(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_thumbnail_scan_completed,
                        ),
                    )
                    .setSubText(bookshelfInfo.bookshelf.displayName)
    ...
    companion object {
        ...
        private const val UNIQUE_WORK_NAME_PREFIX =
            "com.sorrowblue.comicviewer.data.sync.worker.ThumbnailScanWorker:"
