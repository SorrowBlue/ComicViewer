...
internal class FileScanWorker(
                ...
                NotificationCompat
                    ...
                    .setContentTitle(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_file_scan_title,
                        ),
                    )
                    .setContentText(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_file_scan_cancelled,
                        ),
                    )
        ...
        return scanBookshelfUseCase(useCaseRequest).fold({
            val notification =
                NotificationCompat
                    ...
                    .setContentTitle(
                        applicationContext.getString(
                            NotificationR.string.framework_notification_file_scan_completed,
                        ),
                    )
    ...
    companion object {
        ...
        private const val UNIQUE_WORK_NAME_PREFIX =
            "com.sorrowblue.comicviewer.data.sync.worker.FileScanWorker:"
