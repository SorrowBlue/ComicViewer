...
internal class CoilInitializer(private val context: PlatformContext) : BaseCoilInitializer(), Initializer<Unit> {
...
interface CoilProviders {
    ...
    @Provides
    @IntoSet
    private fun provideCoilInitializer(context: PlatformContext): Initializer<*> = CoilInitializer(context)
